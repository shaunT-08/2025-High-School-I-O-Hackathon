...
'''
# Input files
HEALTHY_FOODS = "healthy_foods.csv"
IDEAL_MEAL = "Ideal_Meal.csv"

# Output file
OUTPUT_FILE = "healthy_index_scores.csv"
...
def main():
    ...
    with open(OUTPUT_FILE, "w", encoding="utf-8", newline="") as outfile:
        ...
        with open(HEALTHY_FOODS, "r", encoding="utf-8") as foods_file:
            ...
            for row in reader:
                ...
                healthy_index_score = sum(errors) / 14

                writer.writerow([row["restaurant"], row["item"], round(healthy_index_score, 2)]) # Creates a row with the data